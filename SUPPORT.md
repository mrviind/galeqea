...
| You want to… | Go here |
|---|---|
| **Ask "how do I…?"** or share how you use QE Agent | [GitHub Discussions](https://github.com/mrviind/qe-agent/discussions) — not the issue tracker |
| **Report a bug** — something is broken or wrong | [Open a bug report](https://github.com/mrviind/qe-agent/issues/new?template=bug_report.yml) |
| **Request a feature** (within the testing/QE scope) | [Open a feature request](https://github.com/mrviind/qe-agent/issues/new?template=feature_request.yml) |
...
Include their output, the QE Agent version (`galeqea version`), the operating mode
...
QE Agent is a **test-automation** tool. Feature requests are weighed against that
